      ...
      <div className='row'>
        <div className='col-md-10 mx-auto'>
          <p className='text-center'>
            ...
            Mogadishu, Jubbaland and Southwest States of Somalia. CeRID has its
            headquarters in Belet-Hawa town bordering Mandera Kenya from where
            it provides programme and operational support to all offices.
          </p>
        </div>
      </div>
